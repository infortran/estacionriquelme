        ...
        <div class="row mb-5">
            <div class="col-lg-3 col-md-6 mb-5 mb-md-5">
                <div class="ftco-footer-widget mb-4">
                    ...
                    <p>Bar de barrio para conversar, reír, arreglar el mundo... disfrutando de exquisitos y originales tragos, junto a maravillosas chorrillanas, pizzas, sandwich, y mucho más!</p>
                    <ul class="ftco-footer-social list-unstyled float-md-left float-lft mt-5">
                        <li class="ftco-animate"><a href="https://facebook.com/estacionriquelme"><span class="icon-twitter"></span></a></li>
                        <li class="ftco-animate"><a href="https://facebook.com/estacionriquelme"><span class="icon-facebook"></span></a></li>
                        <li class="ftco-animate"><a href="https://instagram.com/bar_estacionriquelme"><span class="icon-instagram"></span></a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            ...
                            <li><a href="tel:56984110593"><span class="icon icon-phone"></span><span class="text">+56 9 8411 0593 </span></a></li>
